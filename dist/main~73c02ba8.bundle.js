  ...
  [15],
  {
    13: function (e, r, t) {
      ...
      r.a = {
        ...
        _toggleDrawer: function (e, r) {
          e.stopPropagation(), r.classList.toggle("open");
        },
        _closeDrawer: function (e, r) {
          e.stopPropagation(), r.classList.remove("open");
        },
      };
    },
    14: function (e, r, t) {
      ...
      var n = t(8),
        i = t(15),
        o = t(18),
        a = { "/": n.a, "/Resto": n.a, "/detail/:id": i.a, "/favorite": o.a };
      r.a = a;
    },
    16: function (e, r, t) {
      "use strict";
      ...
      var u = {
              ...
              return regeneratorRuntime.wrap(function (r) {
                for (;;)
                  switch ((r.prev = r.next)) {
                    case 0:
                      return (
                        (t = e._resto.id), (r.next = 3), e._isRestoExist(t)
                      );
                    case 3:
                      if (!r.sent) {
                        r.next = 7;
            ...
            regeneratorRuntime.mark(function r() {
              ...
              return regeneratorRuntime.wrap(function (r) {
                for (;;)
                  switch ((r.prev = r.next)) {
                    case 0:
                      return (r.next = 2), n.a.getResto(e);
                    case 2:
        ...
        _renderLike: function () {
          var e = this;
          (this._likeButtonContainer.innerHTML = Object(i.e)()),
                ...
                regeneratorRuntime.mark(function r() {
                  return regeneratorRuntime.wrap(function (r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.next = 2), n.a.putRestos(e._resto);
                        case 2:
                          e._renderButton();
                        case 3:
                        case "end":
        ...
        _renderLiked: function () {
          var e = this;
          (this._likeButtonContainer.innerHTML = Object(i.f)()),
            document.querySelector("#likeButton").addEventListener(
              "click",
              a(
                regeneratorRuntime.mark(function r() {
                  return regeneratorRuntime.wrap(function (r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.next = 2), n.a.deleteResto(e._resto.id);
                        case 2:
                          e._renderButton();
                        case 3:
                        case "end":
